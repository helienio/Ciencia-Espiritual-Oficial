...
El nucleo de esta obra se basa en la desmitificacion de la existencia a traves de la formula de interaccion universal:
...
* [📂 **Ir a la Biblioteca Digital**](./obras-markdown)
    * *Contiene: Manifiesto de la Ciencia Espiritual + Volúmenes I al V.*
...
## ⚖️ Licencia
Esta obra se distribuye bajo la licencia **Creative Commons Atribución-NoComercial-SinDerivadas 4.0 Internacional (CC BY-NC-ND 4.0)**.
* ✅ Eres libre de compartir y copiar el material.
* 🚫 No puedes utilizarlo con fines comerciales.
* 🚫 No puedes alterar, transformar o generar obras derivadas sobre este material.
